 ...
 * @description:
 */
class StationAdAdapter : BaseBindRecyclerAdapter<StationEnsdDetailCouponItemBinding, EPlusItemDto>() {

    override fun getLayoutId(viewType: Int): Int {
        return R.layout.station_ensd_detail_coupon_item
    }

    override fun onBindingItem(binding: StationEnsdDetailCouponItemBinding, item: EPlusItemDto, position: Int) {
